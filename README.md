...
```sh
sudo apt install ./Bazzite-Architect_1.2.0_amd64.deb
```

(Or using dpkg: `sudo dpkg -i Bazzite-Architect_1.2.0_amd64.deb && sudo apt-get install -f`)

- Fedora/RHEL (.rpm):

```sh
sudo dnf install ./Bazzite-Architect-1.2.0.x86_64.rpm
```
